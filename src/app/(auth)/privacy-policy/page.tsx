    ...
    <section className="auth__privacy-policy">
      ...
      <main>
        ...
        <p>
          ...
          безопасности персональных данных, предпринимаемые Authorization (далее
          — Оператор).
        </p>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              веб-сайта https://localhost:3000.
            </p>
          </li>
        </ul>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              Оператора auth@feedback.com с пометкой «Актуализация персональных
              данных».
            </p>
          </li>
          ...
          <li>
            <p>
              ...
              auth@feedback.com с пометкой «Отзыв согласия на обработку
              персональных данных».
            </p>
          </li>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              сети Интернет по адресу http://localhost:3000/privacy-policy.
            </p>
          </li>
        </ul>
      </main>
